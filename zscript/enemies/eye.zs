class PN_Eye : PN_Monster
{
	...
	states
	{
		Spawn:
			FEYE A 4 A_Look;
			FEYE A 0 {if(blinkfactor >= 10){blinkfactor = 0;return A_Jump(256, "Blink");}return ResolveState(null);}
			FEYE A 0 {blinkfactor += random(0,1);}
			FEYE B 4 A_Look;
			FEYE B 0 {if(blinkfactor >= 10){blinkfactor = 0;return A_Jump(256, "Blink");}return ResolveState(null);}
			FEYE b 0 {blinkfactor += random(0,1);}
			FEYE D 4 A_Look;
			FEYE D 0 {if(blinkfactor >= 10){blinkfactor = 0;return A_Jump(256, "Blink");}return ResolveState(null);}
		...
		Missile:
			...
			FEYE I 10 A_FaceTarget;
			FEYE I 0 {if(blinkfactor >= 10){blinkfactor = 0;return A_Jump(256, "Blink");}return ResolveState(null);}
			FEYE J 6 A_FaceTarget;
			FEYE J 0 {if(blinkfactor >= 10){blinkfactor = 0;return A_Jump(256, "Blink");}return ResolveState(null);}
			FEYE K 5 A_CustomBulletAttack(0.0, 0.0, 1, (15 + random(0,3)*5) * (Distance2D(target) <= 256.0 ? 1 : (1 - (Distance2D(target) - 256.0) / 768.0) ** 2 ), "PN_Eye_BlindPuff", 1024, CBAF_NORANDOM | CBAF_NORANDOMPUFFZ);
			FEYE K 0 {blinkfactor += 2;}
		...
		XDeath:
			TNT0 A 0{
				if(tracer && tracer is "PN_Player"){
					...
					pl.vision_dmg += (8 * 35) * (Distance2D(target) <= 256.0 ? 1 : (1 - ((Distance2D(target) - 256.0) / 768.0)));
				}
			}
			Stop;
	}
